...
#' @return None (invisible return).
#'
#' @importFrom tcltk tclCheck tkwm.title tkfocus tkwm.deiconify tkadd tkgrid ttksizegrip tkselect tkcurselection tkitemconfigure tkselection.set tkbind tkdestroy
#' @export
ps <- function(dispPane='co'){
